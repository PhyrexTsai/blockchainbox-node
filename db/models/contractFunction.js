...
ContractFunciton.prototype.readByContractId = function(contractId) {
...
ContractFunction.prototype.create = function(entity) {
    return pool.query("SELECT nextval(pg_get_serial_sequence('contractFunction', 'id')) as id;").then(function(result) {
	    ...
	    return pool.query('INSERT INTO contractEvent (id, contractId, functionName, functionParameters, createTimestamp) VALUES ($1, $2, $3, $4, now())', 
